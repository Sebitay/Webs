...
localStorage.setItem("201",arte1);
localStorage.setItem("202",arte2);
localStorage.setItem("203",arte3);
localStorage.setItem("204",arte4);
localStorage.setItem("205",arte5);
...
for(let i = 0; i<numPersonas; i++){
    let artesano = localStorage.getItem(localStorage.key(i))
    artesano = artesano.split("|");
    if(localStorage.key(i)[0]=="2"){
        agregarArtesano(artesano,localStorage.key(i));
    }
}
